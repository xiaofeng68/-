...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/tran/student/">学员列表</a></li>
		<li class="active"><a href="${ctx}/tran/student/form?id=${student.id}">学员<shiro:hasPermission name="tran:student:edit">${not empty student.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="tran:student:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="student" action="${ctx}/tran/student/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="tran:student:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
